                    ...
                    <section class="related-posts">
                        ...
                        <div class="row">
                            @foreach($relatedPosts as $relatedPost)
                                <a class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                    <img src="{{asset('storage/' . $relatedPost->main_image) }}" alt="featured image"
                                         class="w-100">
                    ...
                    <form action="{{route('post.comment.store', $post->id)}}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-12" data-aos="fade-up">
                                ...
                                <textarea name="message" id="comment" class="form-control" placeholder="write comment"
                                          rows="10"></textarea>
                            </div>
                        </div>
                        <div class="row">
